  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(context, HomeBulb.routeName);
        },
            ...
            Expanded(
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(hour.toString(), style: fontStyle),
                  ),
                ),
              ),
            ),
            Expanded(
              child: Padding(
                ...
                child: Container(
                  ...
                  height: containerSize,
                  child: Center(
                    child: Text(minute.toString(), style: fontStyle),
                  ),
                ),
              ),
            ),
            Expanded(
              child: Padding(
                ...
                child: Container(
                  ...
                  height: containerSize,
                  child: Center(
                    child: Text(second.toString(), style: fontStyle),
                  ),
                ),
              ),
            ),
